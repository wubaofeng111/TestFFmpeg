...
- (void)loadShader{
    ...
    NSString *VSH = [NSString stringWithContentsOfFile:@"/Users/friday/Documents/LearnExample/TestFFmpeg/VideoModule/shader.vsh" encoding:NSUTF8StringEncoding error:nil];
    NSString *FSH = [NSString stringWithContentsOfFile:@"/Users/friday/Documents/LearnExample/TestFFmpeg/VideoModule/shader.fsh" encoding:NSUTF8StringEncoding error:nil];
